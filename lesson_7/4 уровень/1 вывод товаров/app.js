...
function showCategory(category) {
    let newProductsDiv = '';
    let newProductsList = products[category];
    newProductsList.forEach(function(newProduct) {
        newProductsDiv += getProductMarkup(newProduct)
    });
    productEl.insertAdjacentHTML('beforeend', newProductsDiv);
}
